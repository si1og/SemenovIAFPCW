...
\begin{center}
    ...
    \large Отчёт о выполнении практических работ \\[5pt]
    \large По дисциплине: <<Функциональное программирование>>\\[10pt]
    \large На тему: <<Статический анализатор шрифтов в формате bdf>>\\[5pt]
\end{center}
\vspace{80pt}
...
\begin{tabular*}{460pt}{@{\extracolsep{\fill}} l r l}
    Выполнил студент\tabularnewline группы 5130201/40002 & \hspace{60pt} \line(1,0){100} \hspace{-52pt} & Семенов И. А.\\
     & \\
     Проверил \tabularnewline к.т.н & \hspace{60pt} \line(1,0){100} \hspace{-52pt} & Моторин Д. Е. \\
     & \\
     & \\
     & \\
